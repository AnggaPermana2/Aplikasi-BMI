              ...
              children: [
                ClipRRect(
                  borderRadius: BorderRadius.circular(100.100),
                    child: Image.network('https://ik.imagekit.io/dsg/Vector_gXQEJ1ZYsva.jpg', width: 200, height: 200),
                ),
                Text(
                  "Made Angga Permana",
                  style: TextStyle(
                    ...
                    children: <Widget>[
                      Column(
                        ...
                        children: <Widget>[
                          ...
                          ContainIcon(
                              12, "Anime", Icons.movie, Colors.black87),
                        ],
                      ),
                      Column(
                        children: <Widget>[
                          ContainIcon(0, "087723454120", Icons.message, Colors.green),
                          ContainIcon(12, "Singaraja",Icons.location_city, Colors.purple),
                        ],
                      ),
                    ],
                  ),
